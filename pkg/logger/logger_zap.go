...
func (z *Logger) Info(msg string, fields ...any) {
	z.log.Sugar().WithOptions(zap.AddCallerSkip(1)).Infow(msg, fields...)
}

func (z *Logger) Error(msg string, fields ...any) {
	z.log.Sugar().WithOptions(zap.AddCallerSkip(1)).Errorw(msg, fields...)
}

func (z *Logger) Debug(msg string, fields ...any) {
	z.log.Sugar().WithOptions(zap.AddCallerSkip(1)).Debugw(msg, fields...)
}
